    ...
    stages: {
      ...
      setup: {
        ...
        items: [
          ...
          { id: 'hf-s-2', text: 'Prepare registration and intake station with sign-in sheets' },
          ...
          { id: 'hf-s-5', text: 'Set up survey station: tablets charged, survey loaded in kiosk mode, QR codes placed' },
          { id: 'hf-s-6', text: 'Organize resource materials: hygiene kits, health education handouts, referral cards' },
          { id: 'hf-s-7', text: 'Distribute volunteer role assignments, lanyards, and PPE (gloves, masks)' },
        ],
      },
      live_ops: {
        title: 'During Event',
        items: [
          { id: 'hf-lo-1', text: 'Greet and register participants at intake; guide to correct service line' },
          { id: 'hf-lo-2', text: 'Guide participants through screening stations per clinical protocols' },
          { id: 'hf-lo-3', text: 'Distribute health education materials, hygiene kits, and resource cards' },
          { id: 'hf-lo-4', text: 'Collect community surveys (one per participant); promote SMS opt-in' },
          { id: 'hf-lo-5', text: 'Provide referrals as needed (housing, mental health, harm reduction)' },
          { id: 'hf-lo-6', text: 'Track attendance, screening counts, and surveys completed' },
          { id: 'hf-lo-7', text: 'Wear gloves when handling supplies; no photos without consent; no medical advice from non-clinical volunteers' },
        ],
      },
      breakdown: {
        title: 'Post-Event Breakdown',
        items: [
          { id: 'hf-b-1', text: 'Collect all sign-in sheets, screening records, and survey tracking sheets' },
          { id: 'hf-b-2', text: 'Properly dispose of medical waste (sharps, gloves, used supplies)' },
          { id: 'hf-b-3', text: 'Pack up medical equipment, tablets, and supplies; account for inventory' },
          { id: 'hf-b-4', text: 'Clean and sanitize all surfaces' },
          { id: 'hf-b-5', text: 'Log final totals: participants served, screenings, surveys, referrals given' },
          { id: 'hf-b-6', text: 'Debrief with clinical lead and event coordinator' },
        ],
      },
    },
  },
  {
    ...
    stages: {
      ...
      setup: {
        ...
        items: [
          { id: 'sm-s-1', text: 'Review route plan and conduct team safety briefing' },
          { id: 'sm-s-2', text: 'Pack medical supplies, naloxone kits, OraQuick HIV self-test kits, and harm reduction supplies' },
          { id: 'sm-s-3', text: 'Prepare food, hygiene kits, and housing referral forms' },
          { id: 'sm-s-4', text: 'Confirm mobile hotspot and tablets are charged; load survey forms' },
          { id: 'sm-s-5', text: 'Prepare resource cards and referral information (housing, mental health, harm reduction)' },
          { id: 'sm-s-6', text: 'Distribute PPE to all volunteers (gloves, masks, hand sanitizer)' },
          { id: 'sm-s-7', text: 'Set up two service lines: Health Screening Line and Resources Only Line' },
          { id: 'sm-s-8', text: 'Assign volunteer pairs — stay paired at all times, especially in high-traffic areas' },
        ],
      },
      live_ops: {
        title: 'During Outreach',
        items: [
          { id: 'sm-lo-1', text: 'Greet participants warmly: introduce HMC, explain available services (screenings, meals, hygiene kits, housing referrals) without pressure' },
          { id: 'sm-lo-2', text: 'Guide participants to correct line: Health Screening (vitals, HIV testing, SDOH assessment) or Resources Only (food, kits, referrals)' },
          { id: 'sm-lo-3', text: 'Symptomatic check: if participant appears symptomatic, provide mask and direct to appropriate resources' },
          { id: 'sm-lo-4', text: 'HIV testing line: confirm participant has not eaten/drunk in last 20 minutes before OraQuick test' },
          { id: 'sm-lo-5', text: 'Distribute naloxone kits with verbal instructions on use' },
          { id: 'sm-lo-6', text: 'Conduct SDOH surveys with informed consent; log each participant on tracking sheet' },
          { id: 'sm-lo-7', text: 'Collect housing referral data: full name, DOB, contact info, living situation, homelessness history, CES document readiness' },
          { id: 'sm-lo-8', text: 'Record all referrals given (mental health, housing, harm reduction) on tracking sheet' },
          { id: 'sm-lo-9', text: 'Wear gloves when handling food or hygiene supplies; use de-escalation if needed' },
          { id: 'sm-lo-10', text: 'No photos without consent. No medical advice — refer to clinical staff. Alert team lead if situation escalates.' },
        ],
      },
      breakdown: {
        title: 'Post-Outreach Wrap-Up',
        items: [
          { id: 'sm-b-1', text: 'Log total encounters, screenings, surveys, and supplies distributed' },
          { id: 'sm-b-2', text: 'Collect all sign-in sheets, tracking sheets, and housing referral forms' },
          ...
          { id: 'sm-b-5', text: 'Complete post-outreach safety check-in with all volunteers' },
          { id: 'sm-b-6', text: 'Debrief with team lead on observations, referral follow-ups, and any safety concerns' },
        ],
      },
    },
  },
