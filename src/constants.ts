...
export const ROLE_SPECIFIC_MODULES: Record<string, TrainingModule[]> = {
  board_member: [
    { id: 'board_governance_101', title: 'Board of Directors 101: Roles & Responsibilities', desc: 'Legal duties, governance, and oversight for nonprofit board members.', dur: 60, embed: 'https://www.youtube.com/embed/eBGlNprwFM0', format: 'recorded_video', tier: 3, programAssociation: null, isBlocking: true, deadlineDays: null, isAIGenerated: false, req: true },
  ...
  community_advisory_board: [
    { id: 'cab_roles', title: 'Advisory Boards: Roles, Voice, and Community Power', desc: 'How community advisory boards shape programs and accountability.', dur: 20, embed: 'https://www.youtube.com/embed/Li14uGg7IPY', format: 'recorded_video', tier: 3, programAssociation: null, isBlocking: true, deadlineDays: null, isAIGenerated: false, req: true },
    { id: 'board_change_2025', title: 'Beyond Board Training: How to Create Real Change (2025)', desc: 'How modern boards can drive equity, culture, and strategy.', dur: 30, embed: 'https://www.youtube.com/embed/nTUM9NCydM4', format: 'recorded_video', tier: 3, programAssociation: null, isBlocking: false, deadlineDays: null, isAIGenerated: false, req: false },
    // Governance policy documents (real content served from static map)
    { id: 'gov_coi_policy', title: 'Conflict of Interest Policy', desc: 'Official HMC Conflict of Interest Policy. Covers duties to disclose, recusal procedures, and annual acknowledgment requirements.', dur: 15, embed: '', format: 'read_ack', tier: 3, programAssociation: null, isBlocking: true, deadlineDays: null, isAIGenerated: false, req: true },
    { id: 'gov_code_of_ethics', title: 'Code of Ethics', desc: 'Official HMC Code of Ethics. Covers values, conduct, confidentiality, conflicts, use of assets, and compliance.', dur: 10, embed: '', format: 'read_ack', tier: 3, programAssociation: null, isBlocking: true, deadlineDays: null, isAIGenerated: false, req: true },
  ...
  content_writer: [
    { id: 'np_storytelling', title: 'Storytelling for Nonprofits: How to Share Impact with Dignity', desc: 'How to write stories that center dignity, consent, and impact\u2014not trauma.', dur: 22, embed: 'https://www.youtube.com/embed/mujYzq6Iq2E', format: 'recorded_video', tier: 3, programAssociation: null, isBlocking: true, deadlineDays: null, isAIGenerated: false, req: true },
  ],
  social_media_team: [
  ...
  fundraising_volunteer: [
    { id: 'p2p_fundraising', title: 'How to Run a Peer-to-Peer Fundraising Campaign', desc: 'Setting up a page, telling your story, and inviting your network to give.', dur: 18, embed: 'https://www.youtube.com/embed/bpAOG6ZaKIc', format: 'recorded_video', tier: 3, programAssociation: null, isBlocking: true, deadlineDays: null, isAIGenerated: false, req: true },
  ],
  events_coordinator: [
    { id: 'events_for_np', title: 'How to Plan a Nonprofit Event Step by Step', desc: 'Logistics, timelines, and roles for smooth nonprofit events.', dur: 20, embed: 'https://www.youtube.com/embed/pb87UZ1-6RQ', format: 'recorded_video', tier: 3, programAssociation: null, isBlocking: true, deadlineDays: null, isAIGenerated: false, req: true },
  ],
  program_coordinator: [
    { id: 'np_program_mgmt', title: 'Program Management for Nonprofits', desc: 'Designing, running, and evaluating community programs.', dur: 28, embed: 'https://www.youtube.com/embed/U4tpIQ1X4kk', format: 'recorded_video', tier: 3, programAssociation: null, isBlocking: true, deadlineDays: null, isAIGenerated: false, req: true },
  ],
  operations_coordinator: [
    { id: 'np_ops', title: 'Building Simple, Effective Nonprofit Operations', desc: 'How to design processes, checklists, and systems that actually work.', dur: 24, embed: 'https://www.youtube.com/embed/xnNHK9XpIP8', format: 'recorded_video', tier: 3, programAssociation: null, isBlocking: true, deadlineDays: null, isAIGenerated: false, req: true },
  ],
  volunteer_lead: [
    ...
    { id: 'vol_mgmt_top5', title: 'Top 5 Volunteer Management Strategies Every Nonprofit Needs', desc: 'High-level approaches to building a strong volunteer culture.', dur: 12, embed: 'https://www.youtube.com/embed/DpZbxcc77wM', format: 'recorded_video', tier: 3, programAssociation: null, isBlocking: false, deadlineDays: null, isAIGenerated: false, req: false },
  ],
  tech_team: [
  ...
  outreach_lead: [
    { id: 'outreach_strategy_np', title: 'Community Outreach Strategy for Nonprofits', desc: 'How to plan, execute, and measure grassroots outreach campaigns that connect communities to services.', dur: 22, embed: 'https://www.youtube.com/embed/Rx-acgMdnHQ', format: 'recorded_video', tier: 3, programAssociation: null, isBlocking: true, deadlineDays: null, isAIGenerated: false, req: true },
