          ...
          <div className="bg-white p-8 rounded-[40px] border border-zinc-100 shadow-sm hover:shadow-2xl transition-shadow">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="space-y-4">
                 ...
                 <div className="space-y-4">
                   <label className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.2em] px-2">Notifications</label>
                    {isEditing ? (
          ...
          <div className="bg-white p-8 rounded-[40px] border border-zinc-100 shadow-sm hover:shadow-2xl transition-shadow">
            ...
            {isEditing ? (
                 <div className="space-y-6">
                    ...
                    <div>
                        <label className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.2em] block mb-2">Timezone</label>
                 ...
                 <div className="space-y-6">
                    ...
                    <div>
                        <label className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.2em] px-2 mb-2 block">Upcoming Time Off</label>
