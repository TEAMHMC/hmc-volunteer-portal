  ...
  return (
    <div className="space-y-4 md:space-y-8 pb-20">
            ...
            {pendingSessions.length === 0 ? (
              ...
              <div className="divide-y divide-slate-100">
                {pendingSessions.map((session) => (
                  <div key={session.sessionId} className="p-4 hover:bg-zinc-50 transition-colors">
      ...
      {view === 'chat' && chatAvailable && (
        <div className="bg-white rounded-2xl border border-zinc-200 overflow-hidden h-[600px] flex flex-col">
          {activeSession ? (
            <>
              {/* Chat Header */}
              <div className="p-4 border-b border-zinc-200 bg-zinc-50 flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-zinc-200 text-zinc-700 text-sm font-bold rounded-full hover:bg-zinc-300 transition-colors"
                >
                  End Chat
                </button>
              </div>
                    ...
                    <div
                      className={`max-w-[75%] ${
                        message.type === 'volunteer'
                          ...
                          : message.type === 'user'
                          ? 'bg-white border border-zinc-200 text-zinc-800 rounded-2xl rounded-bl-md shadow-elevation-1'
                          : 'bg-zinc-200 text-zinc-800 rounded-2xl rounded-bl-md'
                      } px-4 py-3`}
                    >
                      ...
                      <p className={`text-[10px] mt-1 ${message.type === 'volunteer' ? 'text-brand/40' : 'text-zinc-400'}`}>
              ...
              {/* Input */}
              <form onSubmit={handleSendMessage} className="p-4 border-t border-zinc-200 bg-white">
                <div className="flex items-center gap-3">
                  <input
                    ref={inputRef}
                    type="text"
                    ...
                    className="flex-1 px-4 py-3 border border-zinc-200 rounded-full text-sm focus:outline-none focus:border-brand/40 focus:ring-2 focus:ring-brand/10"
                  />
                  <button
                    type="submit"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-2xl border border-zinc-200 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-zinc-900">{activeSessions.length}</p>
              <p className="text-sm text-zinc-500">Active Chats</p>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-2xl border border-zinc-200 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-zinc-900">{closedSessions.length}</p>
