                    ...
                    <div className="flex items-center gap-3">
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 p-4 bg-zinc-50 border-2 border-zinc-100 rounded-2xl font-bold text-sm outline-none focus:border-brand/30"
                            />
                        </div>
                    ...
                    {displayList.length === 0 ? (
                        ...
                        <div className="space-y-2">
                            {displayList.map(v => {
                                ...
                                return (
                                    <div key={v.id} className={`p-4 rounded-3xl flex items-center justify-between ${isRecommended ? 'bg-emerald-50 border border-emerald-200' : 'bg-zinc-50 border border-zinc-100'}`}>
                        ...
                        <div className="flex items-end gap-2">
                            <div className="flex-1">
                                ...
                                <input
                                    ...
                                    className="w-full p-4 bg-zinc-50 border-2 border-zinc-100 rounded-2xl font-bold text-sm outline-none focus:border-brand/30"
                                />
                            </div>
                            <div className="flex-1">
