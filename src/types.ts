...
export interface ClientRecord {
    ...
    consentDate?: string;
    consentSignature?: string; // Name of person who obtained verbal consent
...
export interface OrgCalendarEvent {
  ...
  type: 'all-hands' | 'committee' | 'training' | 'social' | 'community-event' | 'board' | 'wellness' | 'outreach' | 'workshop' | 'street-medicine' | 'health-fair' | 'other';
